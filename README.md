...
**Note: Steam must be installed, you must be signed in to Steam before running the script, and finally the Steam Autostart entry in task manager must be disabled/deleted.**
