...
Potential solutions are a script written with NIRCMD, or changing the z-order of explorer.exe temporarily via a C++ application. I'll have to do more research.
